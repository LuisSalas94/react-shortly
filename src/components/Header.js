	...
	return (
		<header className="header invisible md:visible max-width md:my-5">
			<div className="flex items-center justify-between">
				...
				{isMenuOpen && (
					<div
						className="absolute left-5 right-5 top-20 rounded bg-slate-900 text-slate-200 text-center py-10 md:relative md:top-0 md:left-0 md:right-0
					md:bg-transparent md:text-slate-700 md:text-left md:py-0 md:flex md:items-center"
					>
